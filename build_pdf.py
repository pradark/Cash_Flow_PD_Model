...
dec_df=pd.read_csv(f'{BASE}/table_decile.csv')
...
story+=[sp(0.2),img(f'{BASE}/fig2_iv_chart.png',w=BODY_W*0.82),
...
story+=[sp(0.2),img(f'{BASE}/fig_woe_pdp_a.png',w=BODY_W),
    fig_caption("3a","WoE partial dependence plots -- feature_7, feature_3, feature_6."),sp(0.3),
    img(f'{BASE}/fig_woe_pdp_b.png',w=BODY_W),
...
story+=[sp(0.2),img(f'{BASE}/fig6_confusion.png',w=BODY_W*0.55),
...
story+=[sp(0.2),img(f'{BASE}/fig7_shap.png',w=BODY_W*0.82),
...
story+=[sp(0.2),img(f'{BASE}/fig_decile.png',w=BODY_W),
...
mc_rules = pd.DataFrame({
    ...
    'Key patterns': [
        r"\bgusto\b | des:pay | direct dep | des:credit | \bonjuno\b | nova credit | \bexpensify\b",
